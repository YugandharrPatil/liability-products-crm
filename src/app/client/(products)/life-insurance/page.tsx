...
export default function LifeInsurance() {
	const methods = useForm<z.infer<typeof lifeInsuranceFormSchema>>({ resolver: zodResolver(lifeInsuranceFormSchema), defaultValues: { name: "", gender: "male", city: "", zip: "", country: "", email: "", address: "", policyType: "Term Life", coverageAmount: 5000, smoke: false, drink: false, medicalCondition: "", medications: "" } });
	const {
